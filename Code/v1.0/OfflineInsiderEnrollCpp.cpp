...
{
    system("chcp 65001");
    cout << "欢迎来到离线Windows预览版注册程序!" << endl;
    cout << endl << "请选择要执行的操作：" << endl;
    cout << "1. 加入 实验性 (未来平台) 频道" << endl;
    cout << "2. 加入 实验性 (26H1) 频道" << endl;
    cout << "3. 加入 实验性 频道" << endl;
    cout << "4. 加入 Beta 频道" << endl;
    cout << "5. 加入 发行预览 频道" << endl;
    cout << "6. 重设所有预览版设置" << endl;
    cout << "7. 离开而不作任何设置" << endl;
    cout << endl;
    int input = 0;
    while(input == 0)
    {
        cout << "请输入你要执行的操作所代表的数字：";
        cin >> input;
